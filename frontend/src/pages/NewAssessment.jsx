...
const NUMERIC_FIELDS = [
  ...
  { key: "AMT_INCOME_TOTAL", label: "Annual Income", step: 10000, hint: "₹" },
  ...
  { key: "prev_app_count", label: "Previous Loans", min: 0, step: 1, hint: "count" },
...
function generateSample() {
  ...
  return {
    ...
    EXT_SOURCE_2: ext(),
    EXT_SOURCE_3: ext(),
    AMT_INCOME_TOTAL: round1000(rand(200000, 2500000)),
    prev_app_count: Math.round(rand(0, 8, 0)),
    AMT_CREDIT: credit,
